...
export function MessageEditor({ text, onSave, onClose, anchorEl }: MessageEditorProps) {
        ...
        >
            <div className="mb-2">
                ...
                <textarea
                    ...
                    className="w-full px-2 py-1.5 text-sm border border-gray-300 rounded resize-none outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    rows={4}
