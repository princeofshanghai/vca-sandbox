    ...
    extend: {
      colors: {
        ...
        shell: {
          ...
          'studio-canvas': 'rgb(var(--shell-studio-canvas) / <alpha-value>)',
          'studio-canvas-grid': 'rgb(var(--shell-studio-canvas-grid) / <alpha-value>)',
          'chrome-divider': 'rgb(var(--shell-chrome-divider) / <alpha-value>)',
          ...
          success: 'rgb(var(--shell-success) / <alpha-value>)',
          'success-soft': 'rgb(var(--shell-success-soft) / var(--shell-success-soft-alpha))',
          'success-border': 'rgb(var(--shell-success-border) / <alpha-value>)',
          'success-text': 'rgb(var(--shell-success-text) / <alpha-value>)',
          ...
          'node-card-surface': 'rgb(var(--shell-node-card-surface) / <alpha-value>)',
          'node-card-divider': 'rgb(var(--shell-node-card-divider) / <alpha-value>)',
          'note-surface': 'rgb(var(--shell-note-surface) / <alpha-value>)',
          'note-border': 'rgb(var(--shell-note-border) / <alpha-value>)',
          'note-text': 'rgb(var(--shell-note-text) / <alpha-value>)',
          'note-muted': 'rgb(var(--shell-note-muted) / <alpha-value>)',
          'note-placeholder': 'rgb(var(--shell-note-placeholder) / <alpha-value>)',
        },
        ...
        'shell-dark': {
          ...
          'accent-text': 'rgb(var(--shell-dark-accent-text) / <alpha-value>)',
