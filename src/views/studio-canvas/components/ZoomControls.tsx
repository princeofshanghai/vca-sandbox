...
export function ZoomControls() {
    ...
    return (
        <div
            ...
            className="absolute bottom-4 right-4 z-50 flex items-center bg-shell-bg dark:bg-shell-surface-subtle rounded-full shadow-md dark:shadow-[0_12px_28px_rgb(0_0_0/0.24)] border border-shell-border/70 dark:border-shell-border/55"
        >
            <button
                onClick={() => zoomOut()}
